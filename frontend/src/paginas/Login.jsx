    ...
    return (
        <>
            ...
            <form
                ...
                <input type="submit" value='Iniciar sesion' className="w-full bg-sky-600 text-white uppercase font-bold py-3 rounded hover:cursor-pointer hover:bg-sky-800 transition-colors mb-5" />
